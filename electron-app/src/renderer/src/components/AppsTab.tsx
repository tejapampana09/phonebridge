...
import { AppWindow, Search, ExternalLink } from 'lucide-react'
    ...
    <div className="flex-1 flex flex-col h-full bg-primary overflow-hidden select-none">
      ...
      <div className="p-6 border-b border-border flex items-center justify-between flex-shrink-0">
        <div>
          ...
          <p className="text-xs text-muted mt-0.5">Browse applications installed on your linked Android device</p>
        </div>
            ...
            {filteredApps.map((app) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Open App visual overlay icon on hover */}
